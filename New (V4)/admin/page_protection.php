...
$active_page = "page_protection";

?>

<?php $page_title = "Page Protection"; require_once("../includes/themes/".THEME_NAME."/admin_header.php"); ?>
...
$(document).ready(function(){
	$("#generate_protection").click(function(){
		...
		if(!levels){
			...
			$("#result").html("<pre>Please paste the following code inside of the page you would like to protect: <br /><em>Note: change $user to $admin if you are going to use this code within the admin panel.</em> <br /><br />&lt;?php protect($user->user_level,\""+levels+"\",\"index.php\"); ?&gt;</pre>");
		}
	});
});
</script>