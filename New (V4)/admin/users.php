...
$header_btn_right = '<a href="create_user.php" class="btn btn-default btn-small">Create User</a>';
...
<?php $page_title = "Users"; require_once("../includes/themes/".THEME_NAME."/admin_header.php"); ?>
	...
	<form action="users.php" method="GET" class="form-search" style="margin-bottom: 10px;">
		<div class="input-group">
			<span class="input-group-addon">Search</span>
			<input type="text" name="search" id="search" placeholder="Please enter your query..." class="form-control search" required="required">
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td class="center"><a href="user_dashboard.php?page=overview&amp;user_id=<?php echo $user->user_id ?>"><img src="../assets/img/pencil.png" alt="edit" class="edit_button" /></a></td>
			</tr>
			<?php endforeach; ?>
		</tbody>
	</table>
