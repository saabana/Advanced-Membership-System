...
if (isset($_POST['submit'])) { // Form has been submitted.
	...
	if ($username != "" && $first_name != "" && $last_name != "" && $email != "" && $country != "" && $gender != "" && $send_welcome_email != "") {
		if(!$check_username){
			if(!$check_email){
				$admin_class->create_account($username, $email, $first_name, $last_name, $signup_ip, $country, $gender, $send_welcome_email);
			} else {
...
<?php $page_title = "Create a User"; require_once("../includes/themes/".THEME_NAME."/admin_header.php"); ?>
	...
	<form action="create_user.php" method="POST" >
		...
		<div class="row-fluid">
			...
			<div class="span3">
		        ...
		        <input type="text" name="last_name" class="span12" required="required" value="<?php echo htmlentities($last_name); ?>" />
			</div>
			<div class="span3">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				<label>Send Welcome Email <em class="req">*</em></label>
				<select name="send_welcome_email" class="span12" required="required" value="<?php echo $send_welcome_email ?>">
