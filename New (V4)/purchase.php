...
<?php echo output_message($message); ?>
	...
	<?php if(isset($_GET['purchase'])) {?>
		...
		<form action="purchase.php?purchase=<?php echo $_GET['purchase']; ?>" method="POST" class="modal" id="purchase" tabindex="-1" role="dialog" aria-labelledby="purchase" aria-hidden="false" style="display: block;">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <a href="purchase.php" class="close" data-dismiss="modal">&times;</a>
		        <h4 class="modal-title">Purchase Access</h4>
		      </div>
		      ...
		      <div class="modal-footer">
		        <a href="purchase.php" class="btn btn-default">Close</a>
