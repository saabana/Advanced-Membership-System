...
function edit(id){
	if(id == "gender" || id == "country" || id == "ip_protection"){
		if(id == "gender"){
			var value = '<?php echo $current_user->gender; ?>';
		} else if(id == "country"){
			var value = '<?php echo $current_user->country; ?>';
		} else if(id == "ip_protection"){
			var value = '<?php echo $current_user->whitelist; ?>';
		}
		$.ajax({
			type: "POST",
			url: WWW+"data.php",
			data: "page=settings&user_id=<?php echo $current_user->user_id; ?>&get_select="+id+"&"+id+"="+value,
...
function save(id){
	...
	if(value != ""){
		$.ajax({
			type: "POST",
			url: WWW+"data.php",
			data: "page=settings&user_id=<?php echo $current_user->user_id; ?>&name="+id+"&value="+value,
			success: function(data){
				if(data == "failure"){
					update_msg();
				} else {
	...
	<div class="span12">
		<table class="settings table">
			<tbody>
				...
				<tr id="first_name">
					<td class="setting"><?php echo $current_user->first_name; ?></td>
				...
				<tr id="last_name">
					<td class="setting"><?php echo $current_user->last_name; ?></td>
				...
				<tr id="username">
					<td class="setting" colspan="2"><?php echo $current_user->username; ?></td>
				...
				<tr id="email">
					<td class="setting"><?php echo $current_user->email; ?></td>
				...
				<tr id="gender">
					<td class="setting"><?php echo $current_user->gender; ?></td>
				...
				<tr id="country">
					<td class="setting"><?php echo $current_user->country; ?></td>
				...
				<tr id="ip_protection">
					<td class="setting"><?php if($current_user->whitelist == 0){echo "Disabled";}else{echo "Enabled";} ?></td>
				...
				<tr id="ip_whitelist">
					<td class="setting"><?php echo $current_user->ip_whitelist; ?></td>
