...
if(isset($_POST['add_note'])){
	...
	if($note == ""){
		$session->message("<div class='alert alert-error'><button type='button' class='close' data-dismiss='alert'>×</button>Please enter a note.</div>");
	} else {
...
<form action="user_dashboard.php?page=staff-notes&amp;user_id=<?php echo $current_user->user_id; ?>" method="post">
	...
	<div class="row-fluid">
		<div class="span12">
			<textarea name="new_note" class="span12" rows="3"></textarea>
		</div>
	</div>
